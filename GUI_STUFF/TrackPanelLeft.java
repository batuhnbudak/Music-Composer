...
public class TrackPanelLeft extends JPanel
{
   ...
   //Constructor
   public TrackPanelLeft(Channels[] channels, CS cs, TrackPanelRight tPanelRight)
   {
      this.channels = channels;
      this.cs = cs;
      this.trackPanel = trackPanel;
      this.tPanelRight = tPanelRight;
      ...
      for (int j = 0; j < channels.length; j++)
      {
         ...
         add(new ChannelsPanel(channels[j], instrumentNames, cs, tPanelRight.getGridPanelArray()[j]), constraints);
      }
